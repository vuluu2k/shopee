<template>
  <div class="container">
    <div class="flex bg-white">
      <div class="thumbnail ml-6">
        <div class="flex flex-col">
          ...
          <div class="mt-4">
            <!-- draw 3 image smaller under -->
            <div class="last:mr-0">
              <div class="inline-block box-border w-1/5 mr-2">
                <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lofawhoqcyk3f3" alt=""
                  style="width: 100px; height: auto;">
              </div>
              <div class="inline-block box-border w-1/5 mr-2">
                <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lofawhoqed4j42_tn" alt=""
                  style="width: 100px; height: auto;">
              </div>
              <div class="inline-block box-border w-1/5">
                <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lofawhoqcyk3f3" alt=""
                  style="width: 100px; height: auto;">
              </div>
            </div>
          ...
          <div class="flex justify-center items-center" style="margin-top: 15px;">
            <div class="flex items-center px-7.5">
              <div class="text-2xl text-black">Chia sẻ:</div><button
                class="sprite-product-sharing sprite-product-sharing-fm tSCitv"
            ...
            <div class="flex items-center _3jkKrB"><button class="IYjGwk" tabindex="0"><svg width="24" height="20"
                  class="x0F377">
                  <path
      ...
      <div class="flex-auto flex-col ml-4">
        <div class="title"><svg width="30" height="16" viewBox="0 0 30 16" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="BSp+Yo">
            ...
            <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              fill="white"></path>
          </svg><span>Gói hút ẩm Balo nữ đi học ZBAG cặp sách vải dù thời trang có ngăn chống sốc đựng vừa laptop 15 6
            inch
            BL26</span></div>
        <div class="flex-auto ">
          <div class="flex mt-12 mr-5">
            ...
            <div>
              <button class="flex px-10">
                <div class="text-2xl border-b-2">1k3 </div>
              ...
              <section class="flex items-center" aria-live="polite">
                <div class="flex items-center price">
                  <div class="flex items-center">
                    <div class="text-red-700 text-5xl font-medium">₫300.000</div>
                  </div>
                </div>
              </section>
            </div>
          ...
          <div class="flex flex-col">
            <section class="flex items-start -mt-1 -ml-1 mb-6 p-1">
              ...
              <div class="h-auto" style="width: 51.5rem;">
                <div class="flex"></div>
                <div class="grid grid-cols-[auto,1fr]"><img
                  ...
                  <div class="col-start-2 ml-[0.7rem]">
                    ...
                    <div class="text-gray-600 font-light mt-[0.2rem]">Miễn phí vận chuyển cho đơn hàng trên ₫99.000</div>
                  </div>
                  <div class="justify-self-center row-start-2 col-start-1"><svg enable-background="new 0 0 15 15"
                      viewBox="0 0 15 15" x="0" y="0" class="shopee-svg-icon icon-free-shipping-line">
                      <g>
                  ...
                  <div class="flex flex-col row-start-2 col-start-2 ml-[0.7rem]">
                    <div class="flex items-center">
                      <div class="text-[#636363] w-[110px] mr-2.5 capitalize">Vận chuyển tới</div>
                      <div class="flex items-center relative">
                        <div class="flex items-center">
                          <div class="relative"><button class="flex items-center"><span
                                class="jtext-black font-medium">Phường
                                Thịnh Quang,
                                Quận Đống Đa</span><svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0"
                    ...
                    <div class="flex items-center">
                      <div class="text-[#636363] w-[110px] mr-2.5 capitalize">phí vận chuyển</div>
                      <div>
                        <div class="shopee-drawer" id="pc-drawer-id-0" tabindex="0">
                          <div class="flex items-center cursor-pointer select-none text-black">₫0<svg
                ...
                <section class="flex items-center" style="margin-bottom: 24px; align-items: baseline;">
                  ...
                  <div
                    ...
                    <button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed" aria-label="Balo đen"
                      aria-disabled="true">Balo đen</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed" aria-label="Balo trắng"
                      aria-disabled="true">Balo trắng</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed" aria-label="Balo xanh dương"
                      aria-disabled="true">Balo xanh
                      dương</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Balo xanh lá" aria-disabled="true">Balo xanh
                      lá</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + hải âu" aria-disabled="true">Đen + hải
                      âu</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + bò sữa" aria-disabled="true">Đen + bò
                      sữa</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + vịt trắng" aria-disabled="true">Đen + vịt
                      trắng</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + ếch xanh" aria-disabled="true">Đen + ếch
                      xanh</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + gấu trắng" aria-disabled="true">Đen + gấu
                      trắng</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Đen + gấu nâu" aria-disabled="true">Đen + gấu
                      nâu</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + hải âu" aria-disabled="true">Trắng + hải
                      âu</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + bò sữa" aria-disabled="true">Trắng + bò
                      sữa</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + vịt trắng" aria-disabled="true">Trắng +
                      vịt trắng</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + ếch xanh" aria-disabled="true">Trắng + ếch
                      xanh</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + gấu trắng" aria-disabled="true">Trắng +
                      gấu trắng</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Trắng + gấu nâu" aria-disabled="true">Trắng + gấu nâu</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dương + hải âu" aria-disabled="true">Xanh dương + hải âu</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dương + bò sữa" aria-disabled="true">Xanh dương + bò
                      sữa</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dươg +vịt trắng" aria-disabled="true">Xanh
                      dươg +vịt trắng</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dương +ếch xanh" aria-disabled="true">Xanh dương +ếch xanh</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dươg +gấu trắng" aria-disabled="true">Xanh dươg +gấu trắng</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh dương + gấu nâu" aria-disabled="true">Xanh dương + gấu
                      nâu</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + hải âu" aria-disabled="true">Xanh lá +
                      hải âu</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + bò sữa" aria-disabled="true">Xanh
                      lá + bò sữa</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + vịt trắng" aria-disabled="true">Xanh lá + vịt trắng</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + ếch xanh" aria-disabled="true">Xanh lá + ếch xanh</button><button
                      class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + gấu trắng" aria-disabled="true">Xanh lá + gấu
                      trắng</button><button class="hUWqqt text-[rgba(0,0,0,.26)] bg-[#fafafa] cursor-not-allowed"
                      aria-label="Xanh lá + gấu nâu" aria-disabled="true">Xanh
                      lá + gấu nâu</button><button class="hUWqqt" aria-label="Gói hút ẩm" aria-disabled="false">Gói hút
                      ẩm</button><button class="hUWqqt" aria-label="Túi hút ẩm" aria-disabled="false">Túi hút ẩm</button>
                  </div>
                </section>
                <section class="flex items-center text-[#757575] mt-4">
                  ...
                  <div class="flex items-center">
                    <div style="margin-right: 15px;">
                      <div class="flex items-center shopee-input-quantity"><button aria-label="Decrease"
                          class="outline-none cursor-pointer border-0 text-sm font-light  flex items-center justify-center transition-colors duration-100 ease-in-out border border-[rgba(0,0,0,.09)] rounded-sm bg-transparent text-[rgba(0,0,0,.8)] w-8 h-8"><svg
                            enable-background="new 0 0 10 10" viewBox="0 0 10 10" x="0" y="0" class="shopee-svg-icon">
                          ...
                          class="outline-none cursor-pointer border-0 text-base font-light  flex items-center justify-center transition-colors duration-100 ease-in-out border border-[rgba(0,0,0,.09)] rounded-sm bg-transparent text-[rgba(0,0,0,.8)] w-8 h-8"><svg
        ...
        <div style="margin-top: 15px;">
          <div class="pl-8">
            <div class="flex"><button type="button"
                ...
                aria-disabled="false"><svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0"
                ...
                aria-disabled="false">Mua ngay</button></div>
          </div>
        </div>
        <div class="flex items-center space-x-10 mt-16">
          <div>
            <div class="relative flex" id="pc-drawer-id-2" tabindex="0">
              <div class="w-full text-2xl text-[#4a4a4a] cursor-help overflow-hidden flex items-center"><img
                  src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/6c502a2641457578b0d5f5153b53dd5d.png"
                  class="w-12 h-12">
                <div class="overflow-hidden overflow-ellipsis whitespace-nowrap">7 ngày miễn phí trả hàng</div>
              </div>
            </div>
          </div>
          <div>
            <div class="relative flex" id="pc-drawer-id-2" tabindex="0">
              <div class="w-full text-2xl text-[#4a4a4a] cursor-help overflow-hidden flex items-center"><img
                  ...
                  class="w-12 h-12">
                <div class="overflow-hidden overflow-ellipsis whitespace-nowrap">Hàng chính hãng 100%</div>
              </div>
            </div>
          </div>
          <div>
            <div class="relative flex" id="pc-drawer-id-2" tabindex="0">
              <div class="w-full text-2xl text-[#4a4a4a] cursor-help overflow-hidden flex items-center"><img
                  ...
                  class="w-12 h-12">
                <div class="overflow-hidden overflow-ellipsis whitespace-nowrap">Miễn phí vận chuyển</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="flex justify-between items-center p-10 page-product__shop">
      <div class="pr-10 box-border border-r border-[rgba(0,0,0,.05)] flex max-w-[44rem]"><a class="mr-5 relative"
          href="/zbagmall?categoryId=100016&amp;entryPoint=ShopByPDP&amp;itemId=19195447056">
          <div class="w-32 h-32">
            <div class="w-full relative pt-full bg-[#f5f5f5] rounded-full overflow-hidden"><svg
              ...
              </svg></div><img alt="click here to visit shop"
              src="https://down-vn.img.susercontent.com/file/c95bc8800cefcda327ada50c7d8dc3ad_tn">
          </div>
          <div class="absolute bottom-0 w-full text-center">
            <div class="official-shop-new-badge"><img class="h-4 w-16"
        ...
        <div class="flex-grow flex flex-col justify-between">
          ...
          <div class=" flex items-center text-[#757575] text-lg">
            <div class="text-lg text-[rgba(0,0,0,.54)] capitalize">Online 42 phút trước</div>
          </div>
          <div class="mt-2 flex"><button type="button" class="btn btn-tinted btn--s btn--inline flex-row capitalize"><svg
                viewBox="0 0 16 16" class="shopee-svg-icon mr-1.25">
                <g fill-rule="evenodd">
                  <path
              ...
              </svg><span>Chat ngay</span></button><a class="btn btn-light btn--s btn--inline btn-light--link Vf+pt4"
              href="/zbagmall?categoryId=100016&amp;entryPoint=ShopByPDP&amp;itemId=19195447056"><svg
              ...
              </svg><span>xem shop</span></a></div>
        </div>
      </div>
      <div class="grid grid-cols-3 gap-x-12 gap-y-5 pl-6 text-[rgba(0,0,0,.4)] flex-grow">
        <div class="cursor-default flex justify-between relative"><label
            class="capitalize text-[rgba(0,0,0,.4)] mr-3">Đánh giá</label><span
            class="text-[var(--brand-primary-color)] whitespace-nowrap text-right">61,2k</span></div>
        <div class="cursor-default flex justify-between relative"><label class="capitalize text-[rgba(0,0,0,.4)] mr-3">tỉ
            lệ phản hồi</label><span class="text-[var(--brand-primary-color)] whitespace-nowrap text-right">87%</span>
        </div>
        <div class="cursor-default flex justify-between relative"><label
            class="capitalize text-[rgba(0,0,0,.4)] mr-3">tham gia</label><span
            class="text-[var(--brand-primary-color)] whitespace-nowrap text-right">9 tháng trước</span></div>
        ...
        <div class="cursor-default flex justify-between relative"><label
            class="capitalize text-[rgba(0,0,0,.4)] mr-3">thời gian phản hồi</label><span
            class="text-[var(--brand-primary-color)] whitespace-nowrap text-right">trong vài
            giờ</span>
        </div>
        <div class="cursor-default flex justify-between relative"><label
            class="capitalize text-[rgba(0,0,0,.4)] mr-3">Người theo dõi</label><span
            class="text-[var(--brand-primary-color)] whitespace-nowrap text-right">1,6k</span></div>
      </div>
    </section>
    <div>
        ...
        <div class="page-product__content--left">
          <div class="product-detail page-product__detail">
            <section class="p-6 pb-0">
              <h2 class="bg-[rgba(0,0,0,.02)] text-[rgba(0,0,0,.87)] text-xl font-normal m-0 p-3.5 capitalize">CHI TIẾT
                SẢN PHẨM</h2>
              <div class="m-12 mx-6 mb-6">
                <div class="flex mb-7"><label class="text-[rgba(0,0,0,.4)] text-lg box-border w-56 pr-3">Danh Mục</label>
                  <div class="flex items-center RnKf-X"><a class="text-[#05a] text-xl no-underline"
                      href="/">Shopee</a><svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0"
                ...
                <div class="flex mb-7"><label class="text-[rgba(0,0,0,.4)] text-lg box-border w-56 pr-3">Thương
                    hiệu</label><a class="text-[#05a]" href="/search?brands=3648799">ZBAG</a></div>
                <div class="flex mb-7"><label class="text-[rgba(0,0,0,.4)] text-lg box-border w-56 pr-3 eqeCX7">Loại bảo
                    hành</label>
                  <div>Bảo hành nhà sản xuất</div>
                </div>
                <div class="flex mb-7"><label class="text-[rgba(0,0,0,.4)] text-lg box-border w-56 pr-3 eqeCX7">Kho
                    hàng</label>
                  <div>16534</div>
                </div>
                <div class="flex mb-7"><label class="text-[rgba(0,0,0,.4)] text-lg box-border w-56 pr-3 eqeCX7">Gửi
                    từ</label>
                  <div>Hà Nội</div>
                </div>
              </div>
                ...
                <div class="product-rating-overview">
                  <div class="product-rating-overview__briefing">
                    <div class="product-rating-overview__score-wrapper"><span
                        class="product-rating-overview__rating-score">5</span><span
                  ...
                  <div class="product-rating-overview__filters">
                    ...
                    <div class="product-rating-overview__filter">5 Sao (1,5k)</div>
                    ...
                    <div class="product-rating-overview__filter">Có Bình luận (67)</div>
                    <div class="product-rating-overview__filter">Có hình ảnh / video (11)</div>
                  </div>
                </div>
                  ...
                  <div class="shopee-product-comment-list">
                    <div class="shopee-product-rating">
                      ...
                      <div class="shopee-product-rating__main">
                        <div class="shopee-product-rating__author-name">t*****o</div>
                        <div class="repeat-purchase-con">
                          <div class="shopee-product-rating__rating"><svg enable-background="new 0 0 15 15"
                              viewBox="0 0 15 15" x="0" y="0"
                              class="shopee-svg-icon icon-rating-solid--active icon-rating-solid">
                              <polygon
                                points="7.5 .8 9.7 5.4 14.5 5.9 10.7 9.1 11.8 14.2 7.5 11.6 3.2 14.2 4.3 9.1 .5 5.9 5.3 5.4"
                                stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"></polygon>
                            </svg><svg enable-background="new 0 0 15 15" viewBox="0 0 15 15" x="0" y="0"
                              class="shopee-svg-icon icon-rating-solid--active icon-rating-solid">
                              <polygon
                                points="7.5 .8 9.7 5.4 14.5 5.9 10.7 9.1 11.8 14.2 7.5 11.6 3.2 14.2 4.3 9.1 .5 5.9 5.3 5.4"
                                stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"></polygon>
                        ...
                        <div class="shopee-product-rating__time">2023-12-12 21:55 | Phân loại hàng: Túi hút ẩm</div>
                        <div
                          ...
                          mới đầu nhìn thì nghĩ bé thế nhưng mà đựng đc nhiều đồ lắm các bạn ơi khá là nhiều ngăn trông
                          cũng rất đẹp với 1 đứa thích sự đơn giản như mình, chất lượng oke mà giá thì rẻ nên mua nha,
                          giao hàng cũng rất nhanh 💯<div
                            ...
                            <div class="rating-media-list__container">
                              <div class="rating-media-list__image-wrapper rating-media-list__image-wrapper--inactive">
                                <div class="shopee-rating-media-list-image__wrapper">
                                  ...
                                  <div class="shopee-rating-media-list-image__content"
                                    style="background-image: url(&quot;https://down-ws-sg.img.susercontent.com/vn-11110103-7r98o-lp6pm8wfy60d64&quot;);">
                              ...
                              <div class="rating-media-list__image-wrapper rating-media-list__image-wrapper--inactive">
                                <div class="shopee-rating-media-list-image__wrapper">
                                  ...
                                  <div class="shopee-rating-media-list-image__content"
                                    style="background-image: url(&quot;https://down-bs-vn.img.susercontent.com/vn-11134103-7r98o-lp6pifabsg2687_tn.webp&quot;);">
                                    <div class="shopee-rating-media-list-image__content--blur"> </div>
                                  </div>
                                </div>
                              </div>
                              <div class="rating-media-list__image-wrapper rating-media-list__image-wrapper--inactive">
                                <div class="shopee-rating-media-list-image__wrapper">
                                  ...
                                  <div class="shopee-rating-media-list-image__content"
                                    style="background-image: url(&quot;https://down-bs-vn.img.susercontent.com/vn-11134103-7r98o-lp6pifac7wb2fd_tn.webp&quot;);">
                                    <div class="shopee-rating-media-list-image__content--blur"> </div>
                                  </div>
                                </div>
                              </div>
                              <div class="rating-media-list__image-wrapper rating-media-list__image-wrapper--inactive">
                                <div class="shopee-rating-media-list-image__wrapper">
                                  ...
                                  <div class="shopee-rating-media-list-image__content"
                                    style="background-image: url(&quot;https://down-bs-vn.img.susercontent.com/vn-11134103-7r98o-lp6pifabsfh71c_tn.webp&quot;);">
                                    <div class="shopee-rating-media-list-image__content--blur"> </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="shopee-product-rating__actions" style="justify-content: space-between;">
                          <div style="display: flex;">
                            <div class="shopee-product-rating__like-button"><svg width="14px" height="13px"
                            ...
                            <div class="shopee-product-rating__like-count">hữu ích?</div>
                          </div>
                          <div style="display: flex;">
                            <div class="shopee-product-rating__report-menu-button">
                              <div class="stardust-dropdown">
                                <div class="stardust-dropdown__item-header">
                                  <div><svg width="4px" height="16px" viewBox="0 0 4 16" version="1.1"
                                ...
                                <div class="stardust-dropdown__item-body">
                                  <div class="shopee-product-rating__report-menu-dropdown">báo cáo</div>
                                </div>
                              </div>
                            </div>
                          </div>
...
<script setup>
import test from '@/assets/icon/test.svg?component'
